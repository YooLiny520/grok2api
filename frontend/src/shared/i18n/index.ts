  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        backgroundJobStarted: "后台任务已启动，可继续其他操作",
        backgroundJobProgress: "后台执行中 {{completed}} / {{total}}",
        backgroundJobCanceled: "后台任务已取消",
        backgroundJobFailed: "后台任务失败",
        jobKindWebQuota: "Grok Web 额度同步",
        jobKindConsoleQuota: "Grok Console 额度同步",
        jobKindBilling: "Billing 额度同步",
        jobKindBatchQuota: "选中账号额度同步",
        jobKindScripts: "账号工具",
        jobKindGeneric: "后台账号任务",
